...
export default function DealerSettings() {
  ...
  const [settings, setSettings] = useState({
    ...
    cardNumber: "**** **** **** 4567",
    cardExpiry: "09/25",
    billingAddress: "123 Main Street, Springfield, MA 01103",
    autoBilling: true,
  })
          ...
          <CardContent className="space-y-6">
            ...
            <div className="pt-4 border-t">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h5 className="font-medium">Lead Alerts</h5>
                    <p className="text-sm text-gray-500">Get notified when new leads are available</p>
                  </div>
                  <Switch checked={settings.leadAlerts} onCheckedChange={() => handleSwitchChange("leadAlerts")} />
                </div>

                <div className="flex items-center justify-between">
                  <div>
                    <h5 className="font-medium">Marketing Updates</h5>
                    <p className="text-sm text-gray-500">Receive marketing tips and best practices</p>
                  </div>
                  <Switch
